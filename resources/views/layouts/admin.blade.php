<!DOCTYPE html>
<html  @if(session()->get('language') == 'ar') direction="rtl" dir="rtl" style="direction: rtl" @else lang="en" @endif>
<!--begin::Head-->
<head><base href="">
    <meta charset="utf-8" />
                        ...
                        <div class="dropdown">
                            ...
                            <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                                <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
                                    @if(App::getLocale()  == 'en')
                                    <img class="h-20px w-20px rounded-sm" src="{{url('en.png')}}" alt="" />
                                        @else

                                        <img class="h-20px w-20px rounded-sm" src="{{url('ar.png')}}" alt="" />
                                    @endif
                                </div>
                            </div>
                            <!--end::Toggle-->
                            ...
                            <div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
                                ...
                                <ul class="navi navi-hover py-4">
                                    ...
                                    <li class="navi-item active">
                                        <a href="{{url('setLang/en')}}" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="{{url('en.png')}}" alt="" />
													</span>
                                    ...
                                    <!--begin::Item-->
                                    <li class="navi-item ">
                                        <a href="{{url('setLang/ar')}}" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="{{url('ar.png')}}" alt="" />
													</span>
