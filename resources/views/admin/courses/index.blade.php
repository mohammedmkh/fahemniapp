...
<div class="card">
    ...
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
        <div class="card-title">
            <h3 class="card-label"> {{ trans('cruds.course.title_singular') }}
        ...
        <div class="card-toolbar">
            ...
            <!--begin::Button-->
            @can('course_create')
                <a href="{{route('admin.courses.create') }}" class="btn btn-primary font-weight-bolder">
											<span class="svg-icon svg-icon-md">
                                                ...
                                                <!--end::Svg Icon-->
											</span> {{ trans('global.add') }} {{ trans('cruds.course.title_singular') }} </a>
            @endif
            <!--end::Button-->
        </div>
    </div>
