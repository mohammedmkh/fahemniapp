    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.conversations.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('accept') ? 'is-invalid' : '' }}" type="number" name="accept" id="accept" value="{{ old('accept', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('end_conv') ? 'is-invalid' : '' }}" type="number" name="end_conv" id="end_conv" value="{{ old('end_conv', '') }}" step="1">
