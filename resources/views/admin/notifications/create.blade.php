    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.notifications.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('action_type') ? 'is-invalid' : '' }}" type="text" name="action_type" id="action_type" value="{{ old('action_type', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('actionid') ? 'is-invalid' : '' }}" type="text" name="actionid" id="actionid" value="{{ old('actionid', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reed') ? 'is-invalid' : '' }}" type="number" name="reed" id="reed" value="{{ old('reed', '') }}" step="1">
                @if($errors->has('reed'))
                    <div class="invalid-feedback">
                        {{ $errors->first('reed') }}
                    </div>
