...
<div class="card">
    <div class="card-header">
        {{ trans('cruds.tutorsCourse.title_singular') }} {{ trans('global.list') }}
    </div>

    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-TutorsCourse">
                <thead>
                    <tr>
                        <th width="10">
...
@endcan
  ...
  let table = $('.datatable-TutorsCourse:not(.ajaxTable)').DataTable({ buttons: dtButtons })
