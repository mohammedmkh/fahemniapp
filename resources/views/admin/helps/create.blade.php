...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.help.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.helps.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('question_ar') ? 'is-invalid' : '' }}" type="text" name="question_ar" id="question_ar" value="{{ old('question_ar', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('question_en') ? 'is-invalid' : '' }}" type="text" name="question_en" id="question_en" value="{{ old('question_en', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('answer_en') ? 'is-invalid' : '' }}" type="text" name="answer_en" id="answer_en" value="{{ old('answer_en', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('answer_ar') ? 'is-invalid' : '' }}" type="text" name="answer_ar" id="answer_ar" value="{{ old('answer_ar', '') }}">
